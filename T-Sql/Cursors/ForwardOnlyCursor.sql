...
-- Forward onluy cursor can be used with static and dynamic cursors
-- allows you to read the data one way only without returning back to previous rows

-- delcare the dynamic as forward only 
Declare dynamic_cursor Cursor Dynamic forward_only for
