...
public static class ProductsEndPoints
{
    ...
    > CreateProduct(CreateProductRequest product, ProductRepository productRepository)
    {
        if (product is null)
    ...
    private static async Task<IResult> GetCsvFile(ProductRepository productRepository)
    {
