...
namespace Migrations_001.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Individual> Individuals { get; set; } // now we added them means the ef core will treat them TPT and to db seperate tables
        public DbSet<Employee> Employees { get; set; } // now we added them means the ef core will treat them TPT and to db seperate tables
