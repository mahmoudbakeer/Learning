...
namespace EF_RawSql.Data.Configurations
{
    public class OfficeConfiguration : IEntityTypeConfiguration<Office>
    {
        public void Configure(EntityTypeBuilder<Office> builder)
        {
            ...
            builder.Property(office => office.Id).ValueGeneratedNever(); // Primary keys are implicitly required.

            builder
                .Property(office => office.OfficeName)
            ...
            builder.HasIndex(office => office.OfficeName).IsUnique();

            builder
                .Property(office => office.OfficeLocation)
                .HasColumnType("VARCHAR")
                .HasMaxLength(255)
                .IsRequired();
